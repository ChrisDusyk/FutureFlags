...
public static class DependencyInjection
{
    ...
    ///
    /// Called during startup when <c>FUTUREFLAGS_APPLY_MIGRATIONS</c> asks for it — the AppHost's
