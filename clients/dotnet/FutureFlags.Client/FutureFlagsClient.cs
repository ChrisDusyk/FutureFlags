...
/// <summary>
/// The default <see cref="IFutureFlagsClient"/>: an in-memory snapshot, refreshed behind the reads.
///
/// <para>
...
///
/// <para>
/// Refreshing happens two ways, and both matter. <c>FutureFlagsRefreshService</c> primes the
...
/// </para>
/// </summary>
internal sealed class FutureFlagsClient(
    EvaluationApiClient api,
    IOptions<FutureFlagsOptions> options,
    ILogger<FutureFlagsClient> logger,
    TimeProvider timeProvider) : IFutureFlagsClient, IDisposable
{
