...
internal sealed class EvaluationApiClient(HttpClient http)
{
    ...
    /// </summary>
    /// <exception cref="FutureFlagsException">The server refused or answered with nonsense.</exception>
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new FutureFlagsException(
                "The FutureFlags server rejected this SDK key. It may have been revoked, or it may " +
        ...
        {
            throw new FutureFlagsException(
                "The FutureFlags server refused this SDK key the ruleset. This package is " +
        ...
        {
            throw new FutureFlagsException(
                $"The FutureFlags server answered {(int)response.StatusCode} for {Path}.");
        }
        ...
        {
            throw new FutureFlagsException(
                "The FutureFlags server's response could not be read. This usually means something " +
        ...
        {
            throw new FutureFlagsException("The FutureFlags server's response was missing its flags.");
        }
