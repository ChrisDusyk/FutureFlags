...
using FutureFlags.Client.Redis.Internal;
...
/// <summary>
/// An <see cref="IFutureFlagsClient"/> backed by <see cref="IFusionCache"/>: an in-memory tier the
...
///
/// <para>
/// This does not wrap <see cref="FutureFlagsClient"/> — it talks to <see cref="EvaluationApiClient"/>
...
/// <see cref="IFutureFlagsClient"/>'s per-flag surface does not expose. <see cref="FetchAsync"/> is
...
/// </para>
/// </summary>
internal sealed class RedisCachedFutureFlagsClient : IFutureFlagsClient
{
    ...
    public RedisCachedFutureFlagsClient(
        EvaluationApiClient api,
        IFusionCache cache,
        IOptions<FutureFlagsOptions> options,
        FutureFlagsRedisCacheOptions redisOptions,
        TimeProvider timeProvider)
    {
        ...
        // FusionCache instead of FutureFlagsRefreshService. FailSafeMaxDuration is the number that
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // default beats an exception, the same contract IFutureFlagsClient makes everywhere else.
        catch (Exception)
        {
            return defaultValue;
        }
    ...
    private static string BuildCacheKey(string keyPrefix, FutureFlagsOptions options)
    {
