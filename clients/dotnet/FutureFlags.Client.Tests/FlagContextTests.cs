...
public class FlagContextTests
{
    ...
    private static (IFutureFlagsClient Client, StubHandler Server) Build(
        Action<FutureFlagsOptions>? configure = null)
    {
        ...
        return (provider.GetRequiredService<IFutureFlagsClient>(), server);
    }
